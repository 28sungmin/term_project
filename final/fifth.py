...
class SetPygame:
    def __init__(self):
        ...
        self.onion_img = pygame.image.load("./img/onion.PNG").convert_alpha()
        self.pickle_img = pygame.image.load("./img/pickle.PNG").convert_alpha()
        self.cheese_img = pygame.image.load("./img/cheese.PNG").convert_alpha()
        self.tomato_img = pygame.image.load("./img/tomato.PNG").convert_alpha()
        self.lettuce_img = pygame.image.load("./img/lettuce.PNG").convert_alpha()
        self.sauce_img = pygame.image.load("./img/sauce.PNG").convert_alpha()
        self.okay1_img = pygame.image.load("./img/icons8-ok-button-96.png").convert_alpha()
        self.bag_img = pygame.image.load("./img/icons8-bag-80.png").convert_alpha()
        self.okay2_img = pygame.image.load("./img/icons8-okay-96.png").convert_alpha()
        self.back_img = pygame.image.load("./img/icons8-back-100.png").convert_alpha()
        self.pay_img = pygame.image.load("./img/icons8-pay-64.png").convert_alpha()
