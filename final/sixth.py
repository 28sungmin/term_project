...
class WhatBurger(Burger):

    def __init__(self, ingredient, screen):
        super().__init__()
    ...
    def order(self, y):
        ...
        draw_text(text, self.text_font, (0, 0, 0), 140, y, self.screen)
...
class WhatBurgerFactory(Factory):
    ...
    def createProduct(self, ingredient) -> Burger:
        return WhatBurger(ingredient, self.screen)
...
class PlayPygame(SetPygame):
    def __init__(self):
        super().__init__()
        self.run = True
        self.factory = WhatBurgerFactory(self.screen)
    ...
    def setBurger(self, ing):
        ...
        burger_ingr.what()
        self.burger_order = WhatBurger(ing, self.screen)
